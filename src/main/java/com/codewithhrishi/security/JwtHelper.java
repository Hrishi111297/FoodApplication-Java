...
public class JwtHelper {
    ...
    public List<GrantedAuthority> auth(String token) {
        Claims claims = getAllClaimsFromToken(token);
        System.out.println(claims.get("authorities"));
        return AuthorityUtils.commaSeparatedStringToAuthorityList(claims.get("authorities").toString());
    }
...
//S	    String roles = populateAuthorities(authorities);
